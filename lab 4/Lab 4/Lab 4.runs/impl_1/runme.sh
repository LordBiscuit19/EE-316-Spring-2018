...
HD_PWD='C:/Users/micro/Vivado EE316/Lab 4/Lab 4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendent_call_system_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flight_attendent_call_system_dataflow.tcl -notrace
