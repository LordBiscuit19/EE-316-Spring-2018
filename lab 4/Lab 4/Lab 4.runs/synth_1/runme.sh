...
HD_PWD='C:/Users/micro/Vivado EE316/Lab 4/Lab 4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendent_call_system_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flight_attendent_call_system_dataflow.tcl
